...
namespace sc
{
	...
	public:
		...
		void load_from_buffer(Stream& data, uint16_t width, uint16_t height, PixelFormat type, bool has_data = true)
		{
			m_pixel_format = type;
	...
	public:
		void load(sc::SupercellSWF& swf, uint8_t tag, bool has_data) {
